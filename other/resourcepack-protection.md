...
If you're using an [external host](../plugin-usage/resourcepack-hosting/) (like [Dropbox](../plugin-usage/resourcepack-hosting/dropbox.md)) don't forget to reupload the pack and update the `config.yml`.

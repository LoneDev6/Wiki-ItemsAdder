# 😄 Using font_images/emojis everywhere
...
Now you can use font_images (emojis) everywhere in other plugins easily! (they must support PlaceholderAPI), check the next link:\

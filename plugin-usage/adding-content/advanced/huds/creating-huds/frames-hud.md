...
The first step is to create a configuration file in your [namespace](../../../beginners/basic-concepts/namespace.md) folder. In this example I'll create a file called `hud.yml`.

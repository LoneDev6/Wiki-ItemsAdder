...
So if you set `textures` like in the example and your **namespace** (is for example) `myitems` you will have to put `example_item.png` \*\*\*\* file inside this folder: `contents\myitems\resourcepack\myitems\textures\item`
...
So if you set `model_path` like in the example and your **namespace** (is for example) `myitems` you will have to put `floating_sword.json` \*\*\*\* file inside this folder: `contents\myitems\resourcepack\myitems\models\item`

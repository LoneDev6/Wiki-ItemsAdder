...
* [资源包托管](plugin-usage/resourcepack-hosting/README.md)
  ...
  * [Google Drive 托管](plugin-usage/resourcepack-hosting/google-drive.md)
  * [OneDrive 托管](plugin-usage/resourcepack-hosting/onedrive.md)
* [添加内容](plugin-usage/adding-content/README.md)
  * [内容文件夹](plugin-usage/adding-content/configs-and-resourcepack.md)
...
* [Minecraft 语言文件](plugin-usage/minecraft-language-files.md)
* [翻译](plugin-usage/translation.md)
* [保护资源包](plugin-usage/resourcepack-protection.md)
* [资源包提示](plugin-usage/fast-resourcepack-tips.md)
* [配方菜单](plugin-usage/ia.md)
* [资源包展示信息](plugin-usage/resourcepack-prompt-message-1.17+.md)

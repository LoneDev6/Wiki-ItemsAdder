...
* [📖 Plugin usage](plugin-usage/README.md)
  ...
  * [🎨 Adding content](plugin-usage/advanced/README.md)
    ...
    * [💃 Player Emotes](plugin-usage/advanced/player-emotes/README.md)
      * [Creation](plugin-usage/advanced/player-emotes/creation.md)
      * [Animations](plugin-usage/advanced/player-emotes/animations.md)
      * [Particles](plugin-usage/advanced/player-emotes/particles.md)
      * [Sounds](plugin-usage/advanced/player-emotes/sounds.md)
      * [Custom skin](plugin-usage/advanced/player-emotes/custom-skin.md)
      * [Spawning](plugin-usage/advanced/player-emotes/spawning/README.md)
        * [Command](plugin-usage/advanced/player-emotes/spawning/command.md)
        * [Citizens](plugin-usage/advanced/player-emotes/spawning/citizens.md)
        * [Mythicmobs](plugin-usage/advanced/player-emotes/spawning/mythicmobs.md)

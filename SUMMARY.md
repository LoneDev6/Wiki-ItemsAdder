...
* [❓ Часто задаваемые вопросы](faq/README.md)
  ...
  * [🚙Баги транспорта](faq/vehicles-bugs/README.md)
    * [Проблемы, связанные с демонтажем](faq/vehicles-bugs/dismount-related-problems.md)
  ...
  * [💎Ошибки блоков/минералов](faq/blocks-minerals-issues/README.md)
    * [Я удалил блоки, но продолжает утверждать, что я использовал все идентификаторы](faq/blocks-minerals-issues/i-removed-blocks-but-keep-saying-that-i-used-all-the-ids.md)
    ...
    * [Глюк с собственными текстурами](faq/blocks-minerals-issues/custom-blocks-glitch-texture/README.md)
      * [Избежание глюков с блоками](faq/blocks-minerals-issues/custom-blocks-glitch-texture/avoid-glitched-blocks.md)
      * [Красный блок (REAL blocks)](faq/blocks-minerals-issues/custom-blocks-glitch-texture/redstone-real-blocks.md)
      * [Нотный блок (REAL\_NOTE)](faq/blocks-minerals-issues/custom-blocks-glitch-texture/noteblocks-real\_note.md)
  ...
  * [Скачать Spigot](faq/download-spigot.md)
    ...
    * [🍭 Новичкам](plugin-usage/adding-content/beginners/README.md)
      ...
      * [⛏ Примеры добавленных предметов](plugin-usage/adding-content/beginners/creating-a-custom-item/README.md)
        ...
        * [Блоки](plugin-usage/adding-content/beginners/creating-a-custom-item/blocks/README.md)
          ...
          * [Опыт из блоков](plugin-usage/adding-content/beginners/creating-a-custom-item/blocks/drop-exp-from-blocks.md)
        * [Топливо](plugin-usage/adding-content/beginners/creating-a-custom-item/fuel.md)
        * [Мешки](plugin-usage/adding-content/beginners/creating-a-custom-item/bundle.md)
    * [💪 Для опытных](plugin-usage/adding-content/advanced/README.md)
      * [Настройки предметов](plugin-usage/adding-content/advanced/item-properties/README.md)
        * [Основы](plugin-usage/adding-content/advanced/item-properties/basic/README.md)
          ...
          * [Шаблоны и варианты](plugin-usage/adding-content/advanced/item-properties/basic/templates-and-variants.md)
      ...
      * [Рецепты крафта](plugin-usage/adding-content/advanced/recipes/README.md)
      ...
      * [🌳 Популяция деревьев](plugin-usage/adding-content/advanced/trees-populators/README.md)
        ...
        * [Популяция](plugin-usage/adding-content/advanced/trees-populators/populator.md)
      ...
      * [Мебель](plugin-usage/adding-content/advanced/furniture/README.md)
      ...
      * [Мобы](plugin-usage/adding-content/advanced/mobs/README.md)
        * [Создание моба](plugin-usage/adding-content/advanced/mobs/creating-the-mob/README.md)
          * [Конфигурация](plugin-usage/adding-content/advanced/mobs/creating-the-mob/configuration.md)
          * [Модель моба](plugin-usage/adding-content/advanced/mobs/creating-the-mob/3d-model.md)
        * [Естественный спав для мобов](plugin-usage/adding-content/advanced/mobs/spawning-custom-mobs-naturally/README.md)

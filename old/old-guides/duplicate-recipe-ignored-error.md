# שגיאת "Duplicate recipe ignored"

אם אתם מקבלים שגיאה דומה לזו, בבקשה עדכנו את ה-Paper או Spigot שלכם לגרסה העדכנית ביותר. אם זו גרסה 1.14.4 לא אומר שהיא מעודכנת, אתם ציריכים להוריד את הגרסה העדכנית ביותר.

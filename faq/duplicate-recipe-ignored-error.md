...
Если ваша консоль выдала подобную ошибку - обновите ядро сервера Paper или Spigot до ПОСЛЕДНЕЙ версии. Если там написано "для версии 1.14.4" - это не значит, что версия ядра последняя, обновите до последней.

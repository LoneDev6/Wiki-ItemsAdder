...
For example [**MCPACKS**](https://mc-packs.net/)**,** [**DropBox**](../../plugin-usage/plugin-configuration/resourcepack-hosting/dropbox.md)**,** [**GoogleDrive**](../../plugin-usage/plugin-configuration/resourcepack-hosting/google-drive.md)**.**
